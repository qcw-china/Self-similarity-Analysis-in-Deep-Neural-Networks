...
class CINIC10(VisionDataset):
    ...
    url = "https://hf-mirror.com/datasets/alexey-zhavoronkin/CINIC10/resolve/main/cinic-10-python.tar.gz?download=true"
...
if __name__ == '__main__':
    ...
    s = CINIC10(root=r'D:\DATASETS\cinic\cinic-10-python', train=True, transform=transforms.ToTensor())
    d,k = s[0]
    print(d.shape)
